...
pub fn get_genesis_config() -> GenesisConfig<DefaultContext> {
    let sequencer_private_key = DefaultPrivateKey::from_hex("ca4abe0571a6e8e8f2caf8a3229a5cb210260ba95e4f0ab2b1348c8a67c93bf1e000b7f860471831d0c7fa61fd348e2347dad47d72131bf8a2c8234bb7b53a9c").unwrap();
...
pub struct SugondatChainChecker {
    current_block_hash: [u8; 32],
}

impl ValidityConditionChecker<ChainValidityCondition> for SugondatChainChecker {
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let da_service = Arc::new(DaProvider::new(
    ...
    let r = get_sequencer_rpc(batch_builder, Arc::clone(&da_service));
    ...
    let da_verifier = Arc::new(SugondatVerifier::new(ChainParams {
        namespace_id: ROLLUP_NAMESPACE_RAW,
    }));
    ...
    for height in start_height.. {
        ...
        let mut checker = SugondatChainChecker {
            current_block_hash: header.hash().0.into(),
        };
