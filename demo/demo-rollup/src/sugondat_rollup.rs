...
use sugondat_da_adapter::service::{DaProvider, DaServiceConfig};
use sugondat_da_adapter::spec::{ChainParams, DaLayerSpec};
use sugondat_da_adapter::verifier::SugondatVerifier;

/// Rollup with SugondatDa
pub struct SugondatDemoRollup {}

#[async_trait]
impl RollupTemplate for SugondatDemoRollup {
    ...
    fn create_verifier(&self) -> <Self::DaService as DaService>::Verifier {
        <SugondatVerifier as DaVerifier>::new(ChainParams {
            namespace_id: ROLLUP_NAMESPACE_RAW,
        })
    }
}

impl WalletTemplate for SugondatDemoRollup {}
